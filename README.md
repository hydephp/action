...
| `framework-version`    | Specify the HydePHP Framework version to use<br>(only applicable for [anonymous projects](https://hydephp.github.io/action/#anonymous-projects)) | "latest"      |
